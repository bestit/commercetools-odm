 ...
 */
class SetCustomerEmail extends CartActionBuilder
{
    /**
     ...
     * @var string
     */
    protected $fieldName = 'customerEmail';
    ...
    public function createUpdateActions(
        ...
        return [CartSetCustomerEmailAction::fromArray([$this->getFieldName() => $changedValue])];
    }
}
